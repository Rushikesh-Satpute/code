...
class Bank{
    ...
    public SavingsAccount createAccount() {
        ...
        String customername=sc.nextLine();    from user
...
public class Banking {
    public static void main(String[] args) {
        ...
        do{
            ...
            switch(choice)   {
                case 1:
                    a=bm.createAccount();    	System.out.println("=============================================");
                    break;
                case 2:
                    bm.displayAccountInformation();  	System.out.println("=============================================");
                    break;
                case 3:
                    bm.checkBalance();
                    System.out.println("=============================================");
                ...
                case 4:
                    ...
                    double amount=sc.nextDouble();
                    bm.depositAmount(amount);        	System.out.println("=============================================");
                    break;
                case 5:
